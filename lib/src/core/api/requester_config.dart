  ...
  static void configure() => RequestPerformer.configure(
    BaseOptions(
      ...
      connectTimeout: Duration(
        milliseconds: AppEnvironment.current.connectTimeout,
      ),
      sendTimeout: kIsWeb
          ? null
          : Duration(milliseconds: AppEnvironment.current.sendTimeout),
      receiveTimeout: Duration(
        milliseconds: AppEnvironment.current.receiveTimeout,
      ),
    ),
